            ...
            <div ref="list" class="list" v-else>
              ...
              <div class="list_item">
                <div class="list_item2" v-for="(item, index) in hotList" :key="index">
                  ...
                  <span @click="getSearch(item.first)" id="list_item2_s2">{{ item.first }}</span>
                </div>
              </div>
              <!-- <div class="list_item">
                <div class="list_item2">
                  <span> 1</span>
                  <span id="list_item2_s2">断线</span>
                </div>
                <div class="list_item2">
                  <span> 1</span>
                 <span id="list_item2_s2">断线</span>
...
.in-ss {
  ...
  width: 180px;
  height: 28px;
  /* background-color: rgba(194, 190, 190, 0.212); */
}
...
#nav .nav-c2 div {
  width: 200px;
  height: 100%;
  /* background-color: rgb(105, 163, 214); */
  display: flex;
  position: absolute;
  right: 60px;
}
