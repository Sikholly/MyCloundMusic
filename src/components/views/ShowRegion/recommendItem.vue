<template>
  <div id="exhibition" style="overflow-y:hidden">
      ...
      <div class="MusicList">
        <table border="0">
          ...
          <tr v-for="(item, index) in allSongs" :key="index">
            ...
            <td class="td2" style="width: 350px" @click="obtainUrl(item.id)">
              {{ item.name }}
            </td>
...
export default {
  ...
  created() {
    axios({
      // http://www.sxly.ml/playlist/detail/?id=5396302207
...
<style scoped>
/* .exhibition-nav , .exhibition-nav2{
...
#exhibition-detailed {
  ...
  /* background-color: rgb(52, 150, 216); */
}
.tis {
  width: 170px;
  height: 170px;
